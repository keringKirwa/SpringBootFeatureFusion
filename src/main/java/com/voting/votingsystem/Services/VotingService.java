...
import com.voting.votingsystem.DTOs.CitizenModel;
import com.voting.votingsystem.DTOs.UpdateVotingStatus;
import com.voting.votingsystem.DTOs.VotingDetails;
...
public class VotingService {
    ...
    public String  registerCitizen(CitizenModel citizenModel) throws Exceptions {
        ...
        if(region==null || name==null|| age <18 || !allowedToVote(citizenId)){
